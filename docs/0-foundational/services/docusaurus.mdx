...
> This guide aims to deploy docusaurus with GitHub Pages and Typesense as search engine.


### Generic

- This guide asume the following cross data
```
website: usen.io
...
#### From Typesense
- Generate these **four** values following the [Typesense](https://usen.io/foundational/services/typesense) guide
...
- DNS provider setup the following records:
...
- **CREATE**  gh action pipeline for build and deploy:
...
- **CREATE** gh action pipeline for scrape and push info to Typesense instance.
...
> now return to github remote acction and finish these steps.
> ~~ happy codign ~~
...
#### [Customize Layout Colors](https://docusaurus.io/docs/styling-layout#styling-your-site-with-infima)
